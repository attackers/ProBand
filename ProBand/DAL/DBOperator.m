...
//    NSString *writeDBPath = [documentsDirectory stringByAppendingPathComponent:targetName];
    ...
    NSString *documentsDirectory1 = [pathArray objectAtIndex:0];
    NSString *path = [documentsDirectory1 stringByAppendingPathComponent:@"/Documentation"];
    NSString *writeDBPath = [path stringByAppendingPathComponent:@"fenda.db"];
