...
+ (NSString *)getBeforeHour:(NSString *)timeString
{
    NSString *str = [timeString componentsSeparatedByString:@"小时"][0];
    NSString *hourStr= [NSString stringWithFormat:@"%@:00",str];
    return hourStr;
}
+ (NSString *)getAfterHour:(NSString *)timeString
{
    NSString *str = [timeString componentsSeparatedByString:@"小时"][0];
    NSString *str1 = [timeString componentsSeparatedByString:@"小时"][1];
    NSString *str2 = [str1 componentsSeparatedByString:@"分"][0];
    NSString *result;
    if ([str2 intValue]>0)
    {
        result = [NSString stringWithFormat:@"%d:00",[str intValue]+1];
    }
    else
    {
        result = [NSString stringWithFormat:@"%d:00",[str intValue]];
    }
    return result;
}

+ (int)getMinutesFromTimeString:(NSString *)timeString
{
    int minutes = 0;
    NSString *str = [timeString componentsSeparatedByString:@"小时"][0];
    NSString *str1 = [timeString componentsSeparatedByString:@"小时"][1];
    NSString *str2 = [str1 componentsSeparatedByString:@"分"][0];
    minutes+= [str intValue]*60;
    minutes+= [str2 intValue];
    return minutes;
}
@end
