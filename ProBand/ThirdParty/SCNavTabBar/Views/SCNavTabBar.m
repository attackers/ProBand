...
- (void)showLineWithButtonWidth:(CGFloat)width
{
    ...
    _line.backgroundColor = UIColorWithRGBA(0.0f, 204.0f, 204.0f, 0.7f);
...
- (CGFloat)contentWidthAndAddNavTabBarItemsWithButtonsWidth:(NSArray *)widths
{
    ...
    for (NSInteger index = 0; index < [_itemTitles count]; index++)
    {
        ...
        [button setTitleColor:COLOR(25, 197, 192) forState:UIControlStateHighlighted];
        
        //添加by Star
        [button setImage:[UIImage imageNamed:_itemImages[index]] forState:UIControlStateNormal];
        [button setImage:[UIImage imageNamed:_itemHighImages[index]] forState:UIControlStateHighlighted];
...
- (NSArray *)getButtonsWidthWithTitles:(NSArray *)titles;
{
    ...
    for (NSString *title in titles)
    {
        ...
        NSNumber *width = [NSNumber numberWithInt:SCREEN_WIDTH/4.0f];//[NSNumber numberWithFloat:size.width + 40.0f];
