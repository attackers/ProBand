...
- (void)initConfig
{
    ...
    _images = @[@"home_daily.png",@"home_pay.png",@"home_sleep.png",@"home_exercise.png"];
    _highImages = @[@"home_daily_sel.png",@"home_pay_sel.png",@"home_sleep_sel.png",@"home_exercise_sel.png"];
...
- (void)viewInit
{
    ...
    _navTabBar.itemImages = _images;
    _navTabBar.itemHighImages = _highImages;
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    [self.delegate navTabbarDidScrollToController:_currentIndex];
}
